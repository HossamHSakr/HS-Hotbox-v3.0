...
export default function App() {
  ...
  return (
    <div 
      ...
      style={{
        // A placeholder OS desktop wallpaper to demonstrate the overlay effect
        backgroundImage: 'url(https://images.unsplash.com/photo-1707343843437-caacff5cfa74?q=80&w=2670&auto=format&fit=crop)',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
      }}
    >
      {/* Some fake window content to show the "overlay" nature over other apps */}
